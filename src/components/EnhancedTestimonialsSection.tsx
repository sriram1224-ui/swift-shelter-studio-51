const testimonials = [
  {
    ...
    quote: "Found my dream apartment in just 2 hours! The verification process gave me complete peace of mind.",
    rating: 5
  },
  {
    name: "Michael Chen",
    ...
    quote: "The instant booking feature is a game-changer. No more waiting weeks for landlord responses!",
    rating: 5
  },
  {
    ...
    quote: "24/7 support team helped me through every step. Best rental experience I've ever had.",
    rating: 5
  }
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="absolute -top-4 -left-4 w-12 h-12 bg-primary rounded-full flex items-center justify-center text-white text-2xl font-serif">
                "
              </div>
              ...
              <div className="flex text-primary mb-6">
                {[...Array(testimonial.rating)].map((_, i) => (
                  <svg key={i} className="w-5 h-5 fill-current animate-scale-in" style={{ animationDelay: `${(index * 0.2) + (i * 0.1)}s` }} viewBox="0 0 20 20">
